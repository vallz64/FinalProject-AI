# Deployment Model CNN (Pandan vs Sirih)

## Deskripsi singkat

Repository ini berisi semua file yang dibutuhkan untuk melakukan deployment model Machine Learning Image Classification menggunakan CNN (Convolutional Neural Network). Adapun model yang digunakan merupakan model untuk memprediksi gambar Pandan vs Sirih.

#

## Sekilas mengenai input model

Agar dapat memprediksi Pandan atau Sirih, data input model harus mengikuti format sebagai berikut:
...
-   pandan_sirih_model_class.h5 --> Model Image Classification CNN yang sudah di-training.
